...
2️Restart Flink docker restart flink-taskmanager docker restart flink-jobmanager

Wait 10–15 seconds ⏳

Verify Installation docker exec flink-jobmanager ls /opt/flink/lib docker exec flink-taskmanager ls /opt/flink/lib
...
Start Streaming Query SELECT * FROM kafka_source;
...
Access PostgreSQL docker exec -it postgres psql -U postgres -d intrusiondb
